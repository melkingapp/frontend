                ...
                <div key={item.label} className="space-y-1 w-full">
                    ...
                    >
                        <Link
                            ...
                            className={`flex items-center px-3 py-2 rounded-xl transition-colors duration-300 w-full ${isActive ? "bg-gradient-to-r from-yellow-500 to-yellow-400 text-[#1C2E4E] font-semibold shadow-lg" : (isMobile ? "hover:bg-gray-100 text-gray-700" : "hover:bg-white/20 text-white")} ${isCollapsed && !isMobile ? "justify-center" : "gap-3"}`}
