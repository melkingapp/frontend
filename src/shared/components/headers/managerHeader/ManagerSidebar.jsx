...
export default function ManagerSidebar({ navItems, sidebarOpen, onCloseSidebar }) {
    ...
    // ⚡ Bolt: Memoize expensive array filtering to prevent main-thread blocking during re-renders
    // Reduces unnecessary recalculations when unrelated component state changes
                ...
                <div key={item.label} className="space-y-1 w-full">
                    ...
                    >
                        <Link
                            ...
                            } ${isCollapsed && !isMobile ? "justify-center" : "gap-3"}`.trim()}
