        ...
        <header className="w-full bg-white border-b-2 border-melkingDarkBlue rounded-b-3xl shadow-md sticky top-0 z-50">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-3 flex items-center justify-between">
                ...
                <div className="flex w-full items-center justify-between md:hidden">
                    <button onClick={() => setMenuOpen(true)} aria-label="باز کردن منو" title="باز کردن منو" className="text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingDarkBlue rounded">
                        ...
                        {isAuthenticated ? (
                            icons.map(({ id, Icon, label, onClick }) => (
                                <button
                                    ...
                                    className="relative group bg-black/10 hover:bg-[#D3B66C]/20 rounded-full text-melkingDarkBlue hover:text-[#D3B66C] p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingDarkBlue"
                                    aria-label={label}
                                    title={label}
                                    type="button"
                                >
                        ...
                        {isAuthenticated ? (
                            icons.map(({ id, Icon, label, onClick }) => (
                                <button
                                    ...
                                    onFocus={() => setHovered(id)}
                                    onBlur={() => setHovered(null)}
                                    className="relative group bg-black/10  hover:bg-[#D3B66C]/20 rounded-full text-melkingDarkBlue hover:text-[#D3B66C] focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingDarkBlue"
                                    aria-label={label}
                                    title={label}
                                    type="button"
                                >
