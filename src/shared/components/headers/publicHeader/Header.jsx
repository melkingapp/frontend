        ...
        <header className="w-full bg-white border-b-2 border-melkingDarkBlue rounded-b-3xl shadow-md sticky top-0 z-50">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-3 flex items-center justify-between">
                ...
                <div className="flex w-full items-center justify-between md:hidden">
                    <button onClick={() => setMenuOpen(true)} aria-label="منو" title="منو" className="text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold rounded-md">
                        <Menu className="w-6 h-6" />
                    </button>

                    <Link to="/" className="mx-auto focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold rounded-md">
                        ...
                        {isAuthenticated ? (
                            icons.map(({ id, Icon, label, onClick }) => (
                                <button
                                    ...
                                    className="relative group bg-black/10 hover:bg-[#D3B66C]/20 rounded-full text-melkingDarkBlue hover:text-[#D3B66C] p-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold"
                                    aria-label={label}
                                    title={label}
                                    type="button"
                                >
                            ...
                            <Link
                                to="/login"
                                className="flex items-center gap-2 bg-[#D3B66C] hover:bg-[#e6c980] transition text-[#1C2E4E] px-3 py-1.5 rounded-md text-sm shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold"
                            >
                                <LogIn size={16} />
                                ورود | ثبت‌نام
                            </Link>
                ...
                <div className="hidden md:flex w-full items-center justify-between">
                    <div className="flex items-center gap-8">
                        <Link to="/" className="focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold rounded-md">
                            <img src={melkingLogo} alt="Melking Logo" className="w-20" />
                        </Link>
                        <nav className="flex gap-6 text-sm font-medium">
                            {navItems.map(({ label, href }) => (
                                <a
                                    key={label}
                                    href={href}
                                    className="hover:text-[#D3B66C] transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold rounded-sm px-1"
                                >
                                    {label}
                                </a>
                            ))}
                        ...
                        {isAuthenticated ? (
                            icons.map(({ id, Icon, label, onClick }) => (
                                <button
                                    ...
                                    onMouseEnter={() => setHovered(id)}
                                    onMouseLeave={() => setHovered(null)}
                                    className="relative group bg-black/10 hover:bg-[#D3B66C]/20 rounded-full text-melkingDarkBlue hover:text-[#D3B66C] focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold"
                                    aria-label={label}
                                    title={label}
                                    type="button"
                                >
                            ...
                            <Link
                                to="/login"
                                className="flex items-center gap-2 bg-[#D3B66C] hover:bg-[#e6c980] transition text-[#1C2E4E] px-4 py-1.5 rounded-md text-sm shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold"
                            >
                                <LogIn size={16} />
                                ورود | ثبت‌نام
                            </Link>
