        ...
        <div className="fixed bottom-6 left-6 z-50" ref={menuRef}>
            <div className="relative">
                ...
                <button
                    ...
                    className={`w-14 h-14 flex items-center justify-center ${color} text-white rounded-full shadow-lg hover:opacity-90 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-melkingGold`}
                >
