...
const Menu = ({ items, open, onSelect, id }) => {
    ...
    return (
        <div
            role="menu"
            id={id}
            className={`absolute left-12 flex flex-col gap-2 items-start transition-all duration-300 ${open ? "opacity-100 scale-100 visible" : "opacity-0 scale-90 invisible pointer-events-none"}`}
