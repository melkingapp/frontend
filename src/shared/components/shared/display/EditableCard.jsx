            ...
            <h3 className="font-semibold mb-3 flex items-center gap-2">
                ...
                {!isEditing && (
                    <button
                        ...
                        className="ml-auto text-gray-500 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C] p-1.5 hover:bg-gray-100 rounded-lg transition-colors"
                        aria-label="ویرایش"
                        title="ویرایش"
                    >
                        <Edit size={16} />
