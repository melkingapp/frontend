    ...
    return (
        <>
            ...
            <div
                ...
                className={`flex flex-col sm:flex-row items-center gap-4 p-4 rounded-xl shadow-sm cursor-pointer transition-all duration-200 bg-white border hover:shadow-md ${borderColor || ""} ${rightBorderColor || ""}`.trim()}
            >
                {/* ستون ۱: اطلاعات سوال */}
                <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-4 w-full">
                    ...
                    <div>
                        <span
                            className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${status === "active" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700" || ""}`.trim()}
                        >
