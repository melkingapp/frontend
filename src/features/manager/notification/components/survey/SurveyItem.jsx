    ...
    return (
        <>
            ...
            <div
                ...
                className={`flex flex-col sm:flex-row items-center gap-4 p-4 rounded-xl shadow-sm cursor-pointer transition-all duration-200 bg-white border hover:shadow-md ${borderColor} ${rightBorderColor}`}
            >
                {/* ستون ۱: اطلاعات سوال */}
