...
export default function UnitBase({ limit, showCreateButton = true, buildingId = null }) {
    ...
    // Optimize unit grouping logic
    // Using useMemo to prevent re-calculation of unit grouping on every render.
    // This logic is O(n) and was previously running on every render.
    // Estimated impact: Reduces main thread work during re-renders, especially with large unit lists.
