      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C]"
            title="بروزرسانی"
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={fetchSchedules}
          disabled={loading}
          className="p-2 text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C]"
          title="بروزرسانی"
          aria-label="بروزرسانی"
        >
                ...
                <div className="flex items-center gap-2 mr-4">
                  {schedule.is_active && (
                    <button
                      ...
                      className="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C]"
                      title="اجرای دستی"
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C] ${
                      schedule.is_active
                  ...
                  <button
                    ...
                    className="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors disabled:opacity-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#D3B66C]"
                    title="حذف"
                    aria-label="حذف"
                  >
                    {isLoading === 'delete' ? (
