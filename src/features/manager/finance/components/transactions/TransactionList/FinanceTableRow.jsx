...
// Performance metric: Wrapping FinanceTableRow in React.memo reduces unnecessary re-renders
// in BuildingTransactionsView and UnitTransactionsView by preventing re-renders when parent state changes
// but the transaction props remain unchanged.
