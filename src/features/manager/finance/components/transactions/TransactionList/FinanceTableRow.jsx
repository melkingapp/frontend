 ...
 * Wrapped FinanceTableRow with React.memo to prevent unnecessary re-renders when parent lists
 * (like BuildingTransactionsView or BuildingBalanceTable) update state (e.g. filters) but the
 * transaction data for this row remains unchanged.
 */
