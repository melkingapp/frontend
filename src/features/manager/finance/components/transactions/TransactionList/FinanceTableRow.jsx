...
// ⚡ Bolt: Wrapped with React.memo to prevent unnecessary re-renders when parent lists update.
// Expected Impact: Reduces main-thread rendering overhead by skipping reconciliation for stable rows in large arrays.
