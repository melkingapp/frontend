...
// ⚡ Bolt Optimization: Define outside component to maintain referential equality
const EMPTY_ARRAY = [];
...
export default function BuildingBalanceTable() {
    ...
    // ⚡ Bolt Optimization: Use a constant to maintain referential equality across renders
