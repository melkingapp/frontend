...
// ⚡ Bolt Optimization: Use a constant reference for empty arrays to prevent unnecessary re-renders
const EMPTY_ARRAY = [];
...
export default function BuildingBalanceTable() {
    ...
    // ⚡ Bolt Optimization: Use EMPTY_ARRAY fallback to preserve referential equality and prevent re-renders
