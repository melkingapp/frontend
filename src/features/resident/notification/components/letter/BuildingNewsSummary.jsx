    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    onClick={() => navigate("/resident/notifications/news")}
            ...
            <div className="text-sm text-gray-600">
                <p>در این بخش می‌توانید آخرین اخبار و اطلاعیه‌های ساختمان را مشاهده کنید.</p>
                <p className="mt-2">توجه: امکان ایجاد خبر جدید فقط برای مدیر ساختمان در دسترس است.</p>
            </div>
        </div>
    );
}
