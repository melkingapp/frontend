...
import { 
  ...
  updateRequestStatus,
  clearError
} from '../../../manager/unitManagement/slices/requestsSlice';
import { 
  User, 
  Building, 
  Home, 
...
const OwnerRentalRequestsList = () => {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      'pending_owner': { color: 'bg-yellow-100 text-yellow-800', text: 'در انتظار تایید شما', icon: Clock },
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            ...
            {/* دکمه‌های عملیات */}
            {selectedRequest.status === 'pending_owner' && (
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">درخواست‌های اجاره واحدهای شما</p>
        </div>
      ...
      {success && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center gap-2 text-green-600">
            ...
            <span className="font-medium">موفقیت</span>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">هنوز هیچ مستاجری برای واحدهای شما درخواست اجاره نداده است.</p>
            </div>
          </div>
        </div>
      ) : (
...
export default OwnerRentalRequestsList;